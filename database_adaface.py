...
conn = sqlite3.connect('/Users/odms/Desktop/photos.db')
c = conn.cursor()
...
adaface_path = "/Users/odms/Documents/aditya_ws/Embeddings/AdaFace"
...
def go_through_adaface():
    ...
    for photo_dir in photo_dirs:
        ...
        for image in images:
            ...
            c.execute('''SELECT adaface_embedding FROM photos WHERE path = ?''', (img_path,))
            result = c.fetchone()
            ...
            c.execute('''UPDATE photos SET adaface_embedding = ? WHERE path = ?''',
